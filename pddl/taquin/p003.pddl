(define (problem taquin-3x3-p003)
  (:domain taquin)
  (:objects
     blank tile1 tile2 tile3 tile4 tile5 tile6 tile7 tile8
  ...
  (:init
     ...
     ;; Définition de la grille (Adjacences)
     ...
     (adjacent p11 p21) (adjacent p21 p11) (adjacent p12 p22) (adjacent p22 p12) (adjacent p13 p23) (adjacent p23 p13)
     (adjacent p21 p31) (adjacent p31 p21) (adjacent p22 p32) (adjacent p32 p22) (adjacent p23 p33) (adjacent p33 p23)
  )
  (:goal (and
